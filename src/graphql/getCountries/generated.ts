...
export const useCountriesQuery = <TData = CountriesQuery, TError = any>(
  client: GraphQLClient,
...
export const useInfiniteCountriesQuery = <TData = CountriesQuery, TError = any>(
  client: GraphQLClient,
  variables?: CountriesQueryVariables,
...
useInfiniteCountriesQuery.getKey = (variables?: CountriesQueryVariables) =>
  variables === undefined
    ? ["Countries.infinite"]
    : ["Countries.infinite", variables];
